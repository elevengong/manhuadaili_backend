...
class Chongqingshishicai extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'chongqingshishicai';
    ...
    {
        parent::__construct();
        $this->caiji_history = 'http://6hcc99.com/history/chongqingshishicai/chongqingshishicaiiframe.php';
        $this->caiji_plan = array(
            '1' => 'http://6hcc99.com/jihua/chongqingshishicai/chongqingshishicaiiframe.php?p=gewei',
            '4' => 'http://6hcc99.com/jihua/chongqingshishicai/chongqingshishicaiiframe.php?p=houer',
            '5' => 'http://6hcc99.com/jihua/chongqingshishicai/chongqingshishicaiiframe.php?p=housan',
            '6' => 'http://6hcc99.com/jihua/chongqingshishicai/chongqingshishicaiiframe.php?p=zuliu',
            '7' => 'http://6hcc99.com/jihua/chongqingshishicai/chongqingshishicaiiframe.php?p=gwdx',
            '8' => 'http://6hcc99.com/jihua/chongqingshishicai/chongqingshishicaiiframe.php?p=wwdx',
            '9' => 'http://6hcc99.com/jihua/chongqingshishicai/chongqingshishicaiiframe.php?p=re'
        );
    }
    ...
    public function handle()
    {
        ...
        $writeContent = date('Y-m-d h:i:s',time()).'--开始采集重庆时时彩开奖记录start'."\r\n";
        ...
        if(empty($lottery))
        {
            $writeContent = date('Y-m-d h:i:s',time()).'--重庆时时彩不存在end'."\r\n";
            $this->writeLogs($writeContent,$logHistoryDir,$logHistoryName);
            exit;
        }
        if($lottery[0]['status'] == 0)
        {
            $writeContent = date('Y-m-d h:i:s',time()).'--重庆时时彩没有开启end'."\r\n";
            $this->writeLogs($writeContent,$logHistoryDir,$logHistoryName);
            exit;
        }
        $l_id = $lottery[0]['l_id'];
        ...
        $writeContent = date('Y-m-d h:i:s',time()).'--重庆时时彩开奖记录采集完成end'."\r\n";
        $this->writeLogs($writeContent,$logHistoryDir,$logHistoryName);

        //开启采集幸运飞艇的计划
        $writeContent = date('Y-m-d h:i:s',time()).'--开启采集重庆时时彩计划start'."\r\n";
        ...
        $writeContent = date('Y-m-d h:i:s',time()).'--重庆时时彩计划采集完成end'."\r\n";
        $this->writeLogs($writeContent,$logPlanDir,$logPlanName);
